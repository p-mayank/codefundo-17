...
####################################-----SUMMARY------#################################################
summary_api_url = "http://api.smmry.com/&SM_API_KEY=AF0DAB6445&SM_LENGTH=7&SM_WITH_BREAK"
...
def translate(request):
  if request.method=='POST':
    ...
    to_trans = request.POST.get("string", "Sample")
    dest_lang = request.POST.get("to_lang", "fr")
    print(to_trans)
    print(dest_lang)
    translated = GetTextAndTranslate(bearer_token, dest_lang, to_trans)
    print(translated)
